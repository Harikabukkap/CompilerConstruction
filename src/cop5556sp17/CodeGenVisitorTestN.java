...
public class CodeGenVisitorTestN {
	...
	public void intLitExp0() throws Exception {
		...
		// directly execute bytecode
		String[] args = new String[] { "1" }; // create String[] array to
												// initialize params
		Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
		instance.run();
	}
	...
	/*
	 * @Test public void testBinaryChain04() throws Exception{ String input =
	 * "p file ident_file , url ident_url {frame ident_frame image ident_img ident_url -> ident_img -> ident_file \n;}"
	 * ; Scanner scanner = new Scanner(input); scanner.scan(); Parser parser =
	 * new Parser(scanner); ASTNode program = parser.parse(); TypeCheckVisitor v
	 * = new TypeCheckVisitor(); program.visit(v, null); show(program);
	 *
	 * //generate code CodeGenVisitor cv = new CodeGenVisitor(devel,grade,null);
	 * byte[] bytecode = (byte[]) program.visit(cv, null);
	 *
	 * //output the generated bytecode CodeGenUtils.dumpBytecode(bytecode);
	 *
	 * //write byte code to file String name = ((Program) program).getName();
	 * String classFileName = "bin/" + name + ".class"; OutputStream output =
	 * new FileOutputStream(classFileName); output.write(bytecode);
	 * output.close(); System.out.println("wrote classfile to " +
	 * classFileName);
	 *
	 * // directly execute bytecode String[] args = new String[0]; //create
	 * command line argument array to initialize params, none in this case
	 * //args[0] = "5"; Runnable instance = CodeGenUtils.getInstance(name,
	 * bytecode, args); instance.run(); }
	 */
	...
	public void subImage() throws Exception {
		...
		// directly execute bytecode
		// String[] args = new String[1]; //create command line argument array
		// to initialize params, none in this case
		// args[0] =
		// "http://www.rd.com/wp-content/uploads/sites/2/2016/04/01-cat-wants-to-tell-you-laptop.jpg";
		String[] args = new String[] {
				"https://s-media-cache-ak0.pinimg.com/736x/3c/90/c2/3c90c2c8621dd72a7dbedaec431e8be7.jpg", "5" }; // create
																													// String[]
																													// array
																													// to
																													// initialize
	...
	public void readFromURLandWriteToFile2() throws Exception {
		...
		// "http://www.rd.com/wp-content/uploads/sites/2/2016/04/01-cat-wants-to-tell-you-laptop.jpg";
		String[] args = new String[] {
				"https://s-media-cache-ak0.pinimg.com/736x/3c/90/c2/3c90c2c8621dd72a7dbedaec431e8be7.jpg", "test.jpg" }; // create
																															// String[]
																															// array
																															// to
																															// initialize
	...
	public void readFromURLandWriteToFile3() throws Exception {
		...
		String[] args = new String[] {
				...
				"test1.jpg" }; // create String[] array to initialize params
		Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
		// Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
		instance.run();
	}
	...
	public void sleepImg() throws Exception {
		...
		String[] args = new String[] {
				"https://s-media-cache-ak0.pinimg.com/736x/3c/90/c2/3c90c2c8621dd72a7dbedaec431e8be7.jpg",
				"sleep.jpg" }; // create String[] array to initialize params
		Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
		// Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
		instance.run();
	}
	// /*\n k <- i-j; k -> f -> show;*/addImage url u {image i image j image k
	// frame f \nu -> i; \nu -> j; \n k <- i-j; k -> f -> show; sleep 5; k <- k
	// + i; k -> f -> show; \n}
	...
	public void booleanBinaryExpression3() throws Exception {
		...
		// args[0] =
		// "http://www.rd.com/wp-content/uploads/sites/2/2016/04/01-cat-wants-to-tell-you-laptop.jpg";
		String[] args = new String[] { "true", "true" }; // create String[]
															// array to
															// initialize params
		Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
		// Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
	...
	public void allTheOps() throws Exception {
		...
		// args[0] =
		// "http://www.rd.com/wp-content/uploads/sites/2/2016/04/01-cat-wants-to-tell-you-laptop.jpg";
		String[] args = new String[] { "sleep.jpg", "sleep.jpg" }; // create
																	// String[]
																	// array to
																	// initialize
																	// params
	...
	public void readFromFile() throws Exception {
		...
		args[0] = "Images/image1";
		args[1] = "Images/image2";
		Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
		// Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
		instance.run();
	}
	...
	public void booleanBinaryExpression() throws Exception {
		...
		String[] args = new String[] {
				"true",
				"false" }; // create String[] array to initialize params
		Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
		// Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
		instance.run();
	}
