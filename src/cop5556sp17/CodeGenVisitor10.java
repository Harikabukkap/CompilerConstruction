...
public class CodeGenVisitor10 implements ASTVisitor, Opcodes {
	 ...
	 */
	public CodeGenVisitor10(boolean DEVEL, boolean GRADE, String sourceFileName) {
		super();
		this.DEVEL = DEVEL;
		this.GRADE = GRADE;
	...
	public Object visitBinaryChain(BinaryChain binaryChain, Object arg) throws Exception {
		...
		if (binaryChain.getE1() instanceof IdentChain) {
			...
			if ((identChain.getDec() instanceof ParamDec)) {
				...
				System.out.println("ALOAD " + identChain.getDec().getSlot());
	...
	public Object visitBinaryExpression(BinaryExpression binaryExpression, Object arg) throws Exception {
		...
		case DIV:
			...
			binaryExpression.getE1().visit(this, arg);
			if ((t0 == TypeName.INTEGER) && (t1 == TypeName.INTEGER)) {
				System.out.println("came hereeeeeeeee");
				mv.visitInsn(IDIV);
				/*
				 * Debug
				 */
	...
	public Object visitBlock(Block block, Object arg) throws Exception {
		...
		for (Dec dec : block.getDecs()) {
			mv.visitLocalVariable(dec.getIdent().getText(), 
					dec.getType().getJVMTypeDesc(), null, blockstart,
		...
		if (side) {
			...
			if (identChain.getDec() instanceof ParamDec) {
				...
				case INTEGER:
					...
					System.out.println("ISTORE " + identChain.getDec().getSlot());
				...
				case IMAGE:
					...
					System.out.println("ASTORE " + identChain.getDec().getSlot());
	...
	public Object visitIdentExpression(IdentExpression identExpression, Object arg) throws Exception {
		...
		if (identExpression.getDec() instanceof ParamDec) {
			...
			System.out.println("why not?  "+ identExpression.getType().toString());
			if (identExpression.getType() == TypeName.INTEGER
				...
				System.out.println("huhhh1 "+ identExpression.getDec().getSlot());
			} else {
				mv.visitVarInsn(ALOAD, identExpression.getDec().getSlot());
				System.out.println("huhhh2 "+ identExpression.getDec().getSlot());
			}
	...
	public Object visitIdentLValue(IdentLValue identX, Object arg) throws Exception {
		...
		if (identX.getDec() instanceof ParamDec) {
			...
			if (identX.getDec().getType() == IMAGE) {
				...
				identX.getDec().setFrame(true);
			} else if (identX.getDec().getType() == TypeName.INTEGER
					|| identX.getDec().getType() == TypeName.BOOLEAN) {
	...
	public Object visitIntLitExpression(IntLitExpression intLitExpression, Object arg) throws Exception {
		...
		System.out.println("pushed int here "+intLitExpression.value );
		return null;
	}
